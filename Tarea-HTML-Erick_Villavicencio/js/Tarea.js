...
document.addEventListener("DOMContentLoaded",function(){
    ...
    function one_action(){
        ...
        console.log("No se puede volver a utilizar este boton")
    ...
    function identificar_click(event){
        if(event.button == 0){
            ...
            console.log("Es botón izquierdo")
        }else if(event.button == 1){
            alert("Es botón central")
            console.log("Es botón central")
        }else if(event.button == 2){
            alert("Es botón derecho")
            console.log("Es botón derecho")
        }
    }
    ...
    function abrir_enlace1(evento){
        ...
        console.log("No se pudo entrar al link")
    }
